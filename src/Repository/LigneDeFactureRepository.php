...
class LigneDeFactureRepository extends ServiceEntityRepository
{
    ...
    /**
     * fonction qui retourne les billets de session du jour
     *
     * @param User $user
     * @return void
     */
    public function getBilletsDeSessionDuJour(User $user)
    {
        $qb = $this->em->createQueryBuilder();
        
        $qb->select('lf')
        ->from(LigneDeFacture::class, 'lf')
        ->join('lf.produit', 'p')
        ->join('lf.facture', 'f')
        ->where('p.billetDeSession = :billetDeSession')
        ->andWhere('f.caissiere = :caissiere')
        ->andWhere('f.dateFactureAt = :dateFactureAt')
        ->setParameter('billetDeSession', 1)
        ->setParameter('caissiere', $user)
        ->setParameter('dateFactureAt', (new DateTime('now'))->format('Y-m-d'))
        ;
    ...
    /**
     * fonction qui retourne les carnets de session du jour
     *
     * @param User $user
     * @return void
     */
    public function getCarnetDuJour(User $user)
    {
        $qb = $this->em->createQueryBuilder();
    ...
    /**
     * fonction qui retourne les echographies de session du jour
     *
     * @param User $user
     * @return void
     */
    public function getEchographiesDuJour(User $user)
    {
        $qb = $this->em->createQueryBuilder();
        ...
        ->join('lf.produit', 'p')
        ->join('lf.facture', 'f')
        ->where('p.echographie = :echographie')
        ->andWhere('f.caissiere = :caissiere')
        ->andWhere('f.dateFactureAt = :dateFactureAt')
        ->setParameter('echographie', 1)
        ->setParameter('caissiere', $user)
        ->setParameter('dateFactureAt', (new DateTime('now'))->format('Y-m-d'))
        ;
    ...
    /**
     * fonction qui retourne les examens de session du jour
     *
     * @param User $user
     * @return void
     */
    public function getExamenDuJour(User $user)
    {
        $qb = $this->em->createQueryBuilder();
        ...
        ->join('lf.produit', 'p')
        ->join('lf.facture', 'f')
        ->where('p.examen = :examen')
        ->andWhere('f.caissiere = :caissiere')
        ->andWhere('f.dateFactureAt = :dateFactureAt')
        ->setParameter('examen', 1)
        ->setParameter('caissiere', $user)
        ->setParameter('dateFactureAt', (new DateTime('now'))->format('Y-m-d'))
        ;
    ...
    /**
     * fonction qui retourne les kits de session du jour
     *
     * @param User $user
     * @return void
     */
    public function getKitDuJour(User $user)
    {
        $qb = $this->em->createQueryBuilder();
    ...
    /**
     * fonction qui retourne les radios de session du jour
     *
     * @param User $user
     * @return void
     */
    public function getRadioDuJour(User $user)
    {
        $qb = $this->em->createQueryBuilder();
