 ...
 */
#[Route('/retenue')]
class ActiverRetenueController extends AbstractController
{
    ...
    public function activerRetenue(Request $request): JsonResponse
    {
        ...
        return new JsonResponse(['success' => true, 'enService' => $retenue->isActif() ]);
    }
}
