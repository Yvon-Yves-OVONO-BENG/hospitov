 ...
 */
#[Route('/recette')]
class RecetteCaissiereDuJourNonSoldeeController extends AbstractController
{
    ...
    #[Route('/recette-caissiere-du-jour-non-soldee', name: 'recette_caissiere_du_jour_non_soldee')]
    public function recetteCaissiereDuJour(Request $request): Response
    {
        ...
        return $this->render('recette_caissiere/recetteDuJourNonSoldee.html.twig', [
            'licence' => 1,
