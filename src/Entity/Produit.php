...
class Produit
{
    ...
    * @var File|null
    ...
    #[ORM\Column(nullable: true)]
    private ?bool $billetDeSession = null;

    #[ORM\Column(nullable: true)]
    private ?bool $echographie = null;
    ...
    #[ORM\Column(nullable: true)]
    private ?bool $carnet = null;

    #[ORM\OneToMany(targetEntity: BilletDeSession::class, mappedBy: 'produit')]
    private Collection $billetDeSessions;

    #[ORM\OneToMany(targetEntity: ListeExamensAFaire::class, mappedBy: 'examen')]
    ...
    public function isBilletDeSession(): ?bool
    {
        return $this->billetDeSession;
    }

    public function setBilletDeSession(?bool $billetDeSession): static
    {
    ...
    public function isEchographie(): ?bool
    {
        return $this->echographie;
    }

    public function setEchographie(?bool $echographie): static
    {
    ...
    public function setCarnet(bool $carnet): static
    {
        $this->carnet = $carnet;
    ...
    public function addBilletDeSession(BilletDeSession $billetDeSession): static
    {
        if (!$this->billetDeSessions->contains($billetDeSession)) {
            ...
            $billetDeSession->setProduit($this);
        }
    ...
    public function removeBilletDeSession(BilletDeSession $billetDeSession): static
    {
        if ($this->billetDeSessions->removeElement($billetDeSession)) {
            // set the owning side to null (unless already changed)
            if ($billetDeSession->getProduit() === $this) {
                $billetDeSession->setProduit(null);
            }
        }
    ...
    public function addListeExamensAFaire(ListeExamensAFaire $listeExamensAFaire): static
    {
        if (!$this->listeExamensAFaires->contains($listeExamensAFaire)) {
            ...
            $listeExamensAFaire->setExamen($this);
        }
    ...
    public function removeListeExamensAFaire(ListeExamensAFaire $listeExamensAFaire): static
    {
        if ($this->listeExamensAFaires->removeElement($listeExamensAFaire)) {
            // set the owning side to null (unless already changed)
            if ($listeExamensAFaire->getExamen() === $this) {
                $listeExamensAFaire->setExamen(null);
            }
        }
